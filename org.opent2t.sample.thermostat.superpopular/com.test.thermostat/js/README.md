...
> some console logging and provide stub values to pass automation tests.
...
```bash
node node_modules/opent2t-onboarding-manual/test.js -n 'Wink Thermostat' -f 'thermostat_id'
```
